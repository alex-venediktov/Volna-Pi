 ...
 * закрытие, доставка в git. Трекера и PR в этой версии нет.
 *
...
export const STAGES: Stage[] = [
	...
	{ name: "visual", level: "optional", title: "визуальная проверка: браузер, ошибки консоли, скриншот", next: "deliver" },
