 ...
 * извлечение опыта в вику, закрытие, доставка в git. Трекера и PR в этой версии нет.
 *
 * Доставка стоит перед close и потому оказывается внутри цикла части: ветка одна на задачу, коммит
 * (и не один, если часть того требует) на каждую часть, а не один коммит на задачу.
 *
 * capture стоит перед доставкой: запись, сделанная до коммита, уезжает тем же коммитом, что и
 * работа. Записанное после доставки чаще всего не записывается вовсе - контекст уходит с задачей.
 *
